...
<div class="main-content">
    ...
    <h2 class="page-title">Department Activity Logs</h2>
        ...
        <form method="GET" class="filter-form">
            ...
            <div class="form-group">
                ...
                <select name="action_type">
                    ...
                    <option value="disable_user" <?= $action_type === 'disable_user' ? 'selected' : '' ?>>Disable User</option>
                    <option value="enable_user" <?= $action_type === 'enable_user' ? 'selected' : '' ?>>Enable User</option>
                </select>
            </div>
